...
void TranslationGizmo::draw(const std::shared_ptr<gizmo_component> &component,
...
Transform TranslationGizmo::drag(
    DragState *state, const std::shared_ptr<gizmo_component> &component,
...
void RotationGizmo::draw(const std::shared_ptr<gizmo_component> &component,
                         const AddTriangleFunc &add_triangle,
                         const Float4x4 &modelMatrix) {
...
void ScalingGizmo::draw(const std::shared_ptr<gizmo_component> &component,
                        const AddTriangleFunc &add_triangle,
                        const Float4x4 &modelMatrix) {
